...
> 当前版本说明，更新于 2026-06-22。本文只描述现行功能与规则；安装、启动和部署命令见项目根目录 [README.md](../README.md)，API 开发约束见 [api-sop.md](./api-sop.md)。
...
- `/draw` 可接收 `drawingName` 作为图纸名称，写入 `rotor_drawings.drawing_name`；前端下载 PDF 时用该名称作为文件名。
