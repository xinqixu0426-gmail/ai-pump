...
| AI 业务语义 | [Business Semantic Frame V1](./business-semantic-frame-v1.md) / [BUS-P2 Enforcement](./business-semantic-enforcement-p2.md) | Shadow 契约与默认关闭的确定性证据规划、完整性回答边界 |
