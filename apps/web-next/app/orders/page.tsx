...
export default async function OrdersPage({
  ...
  const initialDetailTab = ['requirements', 'readiness', 'execution', 'items', 'purchase', 'todos', 'revisions'].includes(String(view))
    ? view as 'requirements' | 'readiness' | 'execution' | 'items' | 'purchase' | 'todos' | 'revisions'
    : 'items';
