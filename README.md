...
当前稳定冻结版本：**水泵ai管理系统 V1.0.1**，标签 `pump-ai-v1.0.1`（2026-09-07）。已部署 Mac Mini，并获用户确认可用；支持跨业务只读查询、成本比较及明确自然语言长期记忆，业务写入未启用。原 `pump-ai-v1.0.0` 标签保留，验收证据与版本边界见 [发布检查清单](docs/deployment-checklist.md)。
