// P1-7: 从 PartsPage.tsx 抽离的自动化测试面板
import { Part } from '../../types';
import {
  Box, Typography, Paper, Chip, Button, Fade, Divider, LinearProgress,
} from '@mui/material';
import {
  Bug as BugReportIcon, Play as PlayIcon,
  CheckCircle as CheckCircleIcon, AlertCircle as ErrorOutlineIcon,
} from 'lucide-react';
import { colors, gradients } from '../../utils/theme';
import { stockStatus } from './partsConstants';
...
export default function HarnessPanel({ parts, testResults, setTestResults, testRunning, setTestRunning }: HarnessPanelProps) {
