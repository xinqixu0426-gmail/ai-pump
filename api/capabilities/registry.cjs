...
const BUSINESS_CAPABILITY_REGISTRY = Object.freeze({
    ...
    'orders.create': defineBusinessCapability({
        ...
        sourceOfTruth: 'configuredRecipeSnapshot+costEngine+recipes.savedCost+inventory+orderSaveDraft+orders',
        riskLevel: 'high',
        supportsPreview: true,
    ...
    'orders.update_draft': defineBusinessCapability({
        ...
        sourceOfTruth: 'configuredRecipeSnapshot+costEngine+orderSaveDraft+orders',
        riskLevel: 'high',
        supportsPreview: true,
        previewPath: '/api/orders/save-payload-draft',
    }),
