...
const BUSINESS_CAPABILITY_REGISTRY = Object.freeze({
    ...
    'parts.create': defineBusinessCapability({
        ...
        sourceOfTruth: 'parts+optional_part_form_business_settings',
        riskLevel: 'medium',
        requiresConfirmation: false,
        supportsPreview: false,
        concurrencyControl: 'not_applicable',
    ...
    'parts.update': defineBusinessCapability({
        ...
        sourceOfTruth: 'parts+pump_shell_templates+optional_part_form_business_settings',
        riskLevel: 'medium',
        requiresConfirmation: false,
        supportsPreview: false,
    }),
    ...
    'parts.save_profile': defineBusinessCapability({
        ...
        sourceOfTruth: 'parts+pump_shell_templates+part_form_business_settings',
        riskLevel: 'critical',
        supportsPreview: true,
        previewPath: '/api/parts/:id/save-preview',
        concurrencyControl: 'confirmationToken_bound_part_and_setting_versions',
    ...
    'orders.list': defineQueryCapability({
        ...
        sourceOfTruth: 'orders+currentPurchasePlan+parts.price+coils.cost',
        riskLevel: 'low',
        callers: Object.freeze(['web', 'ai', 'internal']),
    }),
    ...
    'purchasing.order.item_progress': defineBusinessCapability({
        ...
        outputSchema: 'CommandReceipt<PurchaseItemProgressResult>; ambiguous name-only selection returns 409; preview and apply share inventory identity validation',
    ...
    'purchasing.order.complete_inbound': defineBusinessCapability({
        ...
        outputSchema: 'CommandReceipt<CompletePurchaseResult>; preview and apply share typed inventory target and unit validation',
        sourceOfTruth: 'orderPurchasePlan+parts.stock+coils.stock',
        riskLevel: 'critical',
        supportsPreview: true,
