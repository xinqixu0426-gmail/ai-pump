    ...
    if (!coilChanged) {
        ...
        if (coilCost > 0) {
            snapshotParts.push({
                ...
                unitPrice: Number(coilCalculation.data.unitPrice || 0),
                wireWeight: Number(coilCalculation.data.wireWeight || 0),
                copperBase: Number(coilCalculation.data.copperBase || 0),
