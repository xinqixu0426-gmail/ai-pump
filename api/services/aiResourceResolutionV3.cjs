 ...
 */
const INSTRUCTION_MARKERS_RE = /(?:换成|换为|改为|改成|替换|换掉|重新核算|重新算|核算|算一下|是多少|多少钱|多少|的成本|的价格|去掉|不要|加装|减少|增加|我要找|我想找|帮我|麻烦|查一下|查询|看看|看一下|列出|有哪些|哪个|哪些|是什么|怎么样|整机|成品|库存|明细|清单|详情|成本|价格|报价)/u;
