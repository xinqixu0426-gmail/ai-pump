...
const relationReadMapping = [
    ...
    { existingRelationId: 'coil.recipes', ontologyRelationId: 'coil.used_by_recipe', disposition: 'ADAPTER_REQUIRED', reason: 'ONT-P8R bounded canonical reverse read over the recipes.coil_id foreign key; the canonical-only adapter is the identity restriction because this reader never falls back to legacy names and already pages deterministically.' },
